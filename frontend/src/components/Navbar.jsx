                ...
                <div className="navbar text-gray-800 dark:text-white">
                    ...
                    <div className="navbar-start">
                        ...
                        <div className="dropdown">
                            ...
                            <ul
                                tabIndex={0}
                                className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-white dark:bg-gray-900 rounded-box w-52 max-h-60 overflow-auto border-2"
                            >
                                {items}
                            </ul>
                        </div>
                    ...
                    <div className='navbar-end items-center gap-2 sm:gap-3'>
                        ...
                        <div className='hidden md:flex'>
                            <label className="input bg-white dark:bg-slate-900 dark:text-white border border-gray-400 rounded-md flex items-center gap-2 px-2 py-1">
                        ...
                        {/* Login Modal */}
                        {modalVisible && <Login onClose={() => setModalVisible(false)} />}
                    </div>
                </div>
            </div>
        </>
